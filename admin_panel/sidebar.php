...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#096a09;">
    ...
    <a href="#productsizes"   onclick="showProductSizes()" ><i class="fa fa-th-list"></i> Liste des séances</a>    
