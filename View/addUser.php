...
if (isset($_POST["username"]) && isset($_POST["password"])) {
  if (!empty($_POST['username']) && !empty($_POST["password"])) {
      ...
      $authenticatedUser = $userC->authenticateUser($username, $password);

      if ($authenticatedUser) {
          // Store user information in the session
          $_SESSION['user_id'] = $authenticatedUser['idUser'];          // Replace 'id' with the actual user identifier in your database
          $_SESSION['username'] = $authenticatedUser['username'];
          
          // Display a welcome message
          echo '<center><strong><h3> Welcome user' . $_SESSION["username"] .'</h3></strong></center>';
      } else {
  ...
  <body>
    ...
    <div class="container" id="container">
      ...
      <div class="form-container sign-in">
        <form action="welcome.php" method="post" onsubmit="return verif_In()">
          <h1>Sign in</h1>
